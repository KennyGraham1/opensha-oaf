...
- Raw ETAS rows read: `884031`
- Events kept after `M>=Mc` filtering: `89641`
- Events kept after NZ pyCSEP region filtering: `53078`
- Representative catalog: `sim_0026` with `50` events
- Ensemble event-count median: `50`
- Median indirect (`Gen>=2`) share of `M>=Mc` events: `2.3%`

## Observed Catalog

- Observed catalog: `GeoNet observed 2016p858000 days 7.0-14.0`
- Observed event count in testing region: `323`
- Observed catalog cache: `/home/kennyg/projects/ETASModels/opensha-oaf/build/pycsep_6h/cache/2016p858000_d7_14_mc3_observed.csv`

## Catalog-Test Diagnostics

- Observed events in zero ETAS spatial-rate cells: `17` across `13` spatial cells
- Observed events in zero ETAS space-magnitude bins: `59`
- Zero-rate ETAS spatial cells in testing region: `2553` of `6343`

## Evaluation Results

- `catalog_number_test`: observed statistic `323`, quantile `(0, 1)`, status `normal`
- `catalog_magnitude_test`: observed statistic `0.547739`, quantile `(1, 0)`, status `normal`
- `catalog_spatial_test`: observed statistic `-6.3735`, quantile `(0, 1)`, status `undersampled`
- `catalog_pseudolikelihood_test`: observed statistic `-788.011`, quantile `(1, 0)`, status `undersampled`
- `catalog_resampled_magnitude_test`: observed statistic `0.547739`, quantile `(0.824, 0.176)`, status `normal`
- `catalog_mll_magnitude_test`: observed statistic `133.405`, quantile `(0.376, 0.624)`, status `normal`

## Rolling Diagnostics

- Rolling number-test sub-windows: `7`
- Rolling calibration KS statistic: `0.995` with p-value `1.5625000000000096e-16`

## Generated Files

- `/home/kennyg/projects/ETASModels/opensha-oaf/build/pycsep_6h/cache/2016p858000_d7_14_mc3_observed.csv`
