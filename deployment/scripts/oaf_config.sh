...
# wget https://code.usgs.gov/esc/oaf/opensha-oaf/-/raw/main/deployment/scripts/oaf_config.sh

# You can use these commands to download the script aoaf.h from Github:
# wget https://code.usgs.gov/esc/oaf/opensha-oaf/-/raw/main/deployment/scripts/aoaf.sh
# chmod 755 aoaf.sh
